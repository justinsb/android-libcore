 ...
 *
 */
public final class PureJavaJSSEProvider extends Provider {
	private static final long serialVersionUID = 1898020848653300028L;
	
	public static final String KEY = "PureJavaJSSE";

    public PureJavaJSSEProvider() {
        super(KEY, 1.0, "PureJava (Android/Harmony) JSSE Provider");

        put("SSLContext.SSL", PureJavaSSLContextImpl.class.getName());
        put("SSLContext.SSLv3", PureJavaSSLContextImpl.class.getName());
        put("SSLContext.TLS", PureJavaSSLContextImpl.class.getName());
        put("SSLContext.TLSv1", PureJavaSSLContextImpl.class.getName());
